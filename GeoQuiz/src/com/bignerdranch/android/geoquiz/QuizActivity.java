...
public class QuizActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIsCheater = new boolean[mAnswerKey.length];
        for(int i = 0; i < mAnswerKey.length; i++){
            mIsCheater[i] = false;
        }

        TextView build = (TextView)findViewById(R.id.apiBuild);
        Integer buildInt = Build.VERSION.SDK_INT;
        build.setText("API level " + buildInt.toString());
